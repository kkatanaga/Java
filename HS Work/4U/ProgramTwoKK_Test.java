...
public class ProgramTwoKK_Test
{
	...
	boolean outcome;  
	int maxIndex = 5;                                                                  // Boolean for whether the reportTitle exceeds 40 characters (false) or not (true)
	String array [] = new String [maxIndex];
	...
	{                                                                                           // Try in order to avoid crashing
		...
		for (int row = 0; row < 4; row++) {
		    ...
		    array [row] = lineText.substring (0, lineText.indexOf (',') );
		...
		System.out.println (temp);                                                          // Prints out the line read after the first line (title)
