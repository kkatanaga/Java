/*////////////////////////////////////////////////////////////////////////////////////
// Program Name: BMI_Calculator_2_1.java                                            //
// Name: Keigo Katanaga                                                             //
// Date: 04/15/2020                                                                 //
//                                                                                  //
// Description:                                                                     //
...
// Patient's Name                                                                   //   
// Height (inches; still works as negative values, but not zero)                    //
// Weight (lbs; does not work as zero nor negative values)                          //
// Can accept any number of set of inputs, as long as all inputs are complete.      //
*/////////////////////////////////////////////////////////////////////////////////////

import java.io.*;                                                                                                                   // Imports java.io functions

public class BMI_Calculator_2_1
{
	...
	try
	{
		...
		{
		    System.out.println ("Height and weight cannot be zero nor negative; inadmissible.");                            // Prints an error message for any zero or negative value in height & weight
		    System.out.println ();                                                                                          // Prints a blank to move to the next line
		}
		else if (height == 0)
		{
		    System.out.println ("Cannot divide by zero; inadmissible.");                                                    // Prints an error message for zero height
		    System.out.println ();                                                                                          // Prints a blank to move to the next line
		}
		else if (weight <= 0)
		{
		    System.out.println ("Weight cannot be zero nor negative; inadissible.");                                        // Prints an error message for any zero or negative value in weight
		    System.out.println ();                                                                                          // Prints a blank to move to the next line
		}
		else
		{
			...
			if (height < 0)
			{
			System.out.println ("Height is negative; can calculate, but watch out next time!");                         // Prints an warning message for any zero or negative value in height
			}                                                                                                           // End if statement
			...
			if (height < 0)
			{
			System.out.println ("Height is negative; can calculate, but watch out next time!");                         // Prints a warning message for any zero or negative value in height
			}                                                                                                           // End if statement
